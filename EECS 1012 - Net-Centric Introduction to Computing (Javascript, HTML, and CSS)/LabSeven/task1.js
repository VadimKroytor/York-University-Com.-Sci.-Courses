...
function myFunction2() {
  ...
  $("regex2").innerHTML = "Regular Expression: " + testString;
...
function myFunction3() {
  ...
  $("regex3").innerHTML = "Regular Expression: " + testString;
...
function myFunction4() {
  /* Put in the correct regular expression below */
  var re = /^[A-Z]{4, 600}[0-9][0-9][0-9]$/;
  var testString = $("input4").value;
  $("regex4").innerHTML = "Regular Expression: " + testString;
...
function myFunction5() {
  ...
  $("regex5").innerHTML = "Regular Expression: " + testString;
